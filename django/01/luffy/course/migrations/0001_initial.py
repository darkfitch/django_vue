# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-05-31 10:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beief', models.TextField(max_length=2048, verbose_name='课程(模块)概述')),
                ('level', models.SmallIntegerField(choices=[(0, '初级'), (1, '中级'), (2, '高级')], default=1)),
                ('pub_data', models.DateField(blank=True, null=True, verbose_name='发布日期')),
                ('period', models.PositiveIntegerField(default=7, verbose_name='建议学期周期(day)')),
                ('order', models.IntegerField(help_text='从上一个课程的数字往后排', verbose_name='课程顺序')),
                ('attachment_path', models.CharField(blank=True, max_length=128, null=True, verbose_name='课件路径')),
                ('status', models.SmallIntegerField(choices=[(0, '上线'), (1, '下线'), (2, '预上线')])),
                ('template_id', models.SmallIntegerField(default=1, verbose_name='模版编号')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courserchapters', to='course.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career_improvement', models.TextField(max_length=1024, verbose_name='课程先求要求')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(max_length=128, verbose_name='内容')),
                ('course_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.CourseDetial')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section_type', models.SmallIntegerField(choices=[(0, '文档'), (1, '联系'), (2, '视频')], default=2)),
                ('section_link', models.CharField(blank=True, help_text='若是video，填vid,若是文档，填link', max_length=255, null=True)),
                ('video_time', models.CharField(blank=True, help_text='只在前端展示用', max_length=32, null=True, verbose_name='视频时长')),
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursesections', to='course.CourseChapter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor_compenstaion_bonus', models.PositiveIntegerField(default=15000, verbose_name='导师辅导费')),
                ('period', models.PositiveIntegerField(default=150, verbose_name='建议学习周期(day)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time_percent', models.PositiveSmallIntegerField(help_text='只填数值,eg:10表示10%', verbose_name='奖励等级(时间百分比)')),
                ('value', models.PositiveIntegerField(verbose_name='奖学金金额')),
                ('degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.DegreeCourse')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='course',
            name='degree_course',
            field=models.ForeignKey(blank=True, help_text='如果是学位课,关联学位表', null=True, on_delete=django.db.models.deletion.CASCADE, to='course.DegreeCourse'),
        ),
        migrations.AddField(
            model_name='course',
            name='sub_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.CourseSubCategory'),
        ),
